...
# 设置路径
input_dir="/home/liuzhh/bacteria_cluster/260811_allgenome_ani/result/predicted_gff"
output_dir="/home/liuzhh/bacteria_cluster/260811_allgenome_ani/result/predicted_cgff"
file_format=".gff"
...
success=$(find -L "$output_dir" -name "*.gff" -type f | wc -l)
